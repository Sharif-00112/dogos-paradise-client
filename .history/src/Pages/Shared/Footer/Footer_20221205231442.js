...
const Footer = () => {
    return (
            ...
            <Box sx={{ flexGrow: 1 }}>
                <Grid container spacing={2}>
                    <Grid item style={{ textAlign: 'left'}} xs={6} md={3}>
                        <Typography sx={{ my:2, fontSize: 18, fontWeight: 600 }} style={{color: 'coral', fontWeight: 500, fontSize: 25 }} variant="h6" component="div">
                            All we provide
                        </Typography>
                        <Link 
                    ...
                    <Grid item style={{ textAlign: 'left'}} xs={6} md={3}>
                        ...
                        <Typography sx={{ mt:7, fontSize: 16, fontWeight: 400, color:'coral' }} variant="" component="div">
                                Call Now
                        </Typography>
        ...
        <Typography sx={{ p:2, fontSize: 14, fontWeight: 400, color: 'coral' }} variant="" component="div">
