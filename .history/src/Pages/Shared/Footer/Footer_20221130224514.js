            ...
            <Box sx={{ flexGrow: 1 }}>
                <Grid container spacing={2}>
                    <Grid item style={{ textAlign: 'left'}} xs={6} md={6}>
                        ...
                        <Link style={{ textDecoration:'none', m:1, color: 'red', fontWeight: 500, fontSize: 16 }} to = '/emergencyDentalCare'>
                            Most Adorable Puppies 
                        </Link>
                        <br />
                        <Link style={{ textDecoration:'none', color: 'red', fontWeight: 500, fontSize: 16 }} to = '/checkUp'>
                            Puppies Foods
                        </Link>
                        <br />
                        <Link style={{ textDecoration:'none', color: 'red', fontWeight: 500, fontSize: 16 }} to = '/checkUp'>
