            ...
            <Box sx={{ flexGrow: 1 }}>
                <Grid container spacing={2}>
                    <Grid item style={{ textAlign: 'left'}} xs={6} md={6}>
                        ...
                        <Link style={{ textDecoration:'none', color: 'red', fontWeight: 500, fontSize: 20 }} to = '/emergencyDentalCare'>
                            Emergency Dental Care
                        </Link>
                        <br />
                        <Link style={{ textDecoration:'none', color: 'red', fontWeight: 500, fontSize: 20 }} to = '/checkUp'>
                            Check Up
                        </Link>
                        <br />
