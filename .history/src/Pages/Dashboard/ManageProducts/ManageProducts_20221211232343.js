...
const ManageProducts = () => {
    ...
    const handleAddProductModalOpen = () => setOpenAddProductModal(true);
    const handleAddProductModalClose = () => setOpenAddProductModal(false);

    //update product modal
    const [openUpdateProductModal, setOpenUpdateProductModal] = React.useState(false);
    const handleUpdateProductModalOpen = () => setOpenUpdateProductModal(true);
    const handleUpdateProductModalClose = () => setOpenUpdateProductModal(false);
    ...
    return (
        <div>
            ...
            <UpdateProductModal
                handleUpdateProductModalClose={handleUpdateProductModalClose}
